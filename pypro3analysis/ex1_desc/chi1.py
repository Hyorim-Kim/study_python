...
print(ctab)
print('기댓값 작성')  # 기댓값은 확률변수에 대해 평균적으로 기대하는 값이라는 의미를 갖은 용어로 평균과 같은 개념
...
# 해석 : c.v는 3.84, chi2는 3.0이므로 귀무기각 실패
...
# 해석 : p-value(0.1489) > α(0.05)이므로 귀무가설 기각 실패(채택)
