...
grid_dtree.fit(x_train, y_train)  # GridSearchCV를 이용해서 자동으로 복수의 내부 모형을 생성하고 실행시켜 최적의 파라미터를 찾아줌

import pandas as pd
score_df = pd.DataFrame(grid_dtree.cv_results_)
print(score_df)

print('GridSearchCV가 추천하는 최적 파라미터 : ', grid_dtree.best_params_)
print('GridSearchCV가 추천하는 최적 정확도 : ', grid_dtree.best_score_)
