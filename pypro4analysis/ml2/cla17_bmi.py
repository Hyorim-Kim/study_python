...
# 예) 키: 171, 몸무게: 68     68 / ((170 / 100) * (170 / 100))
...
print(newdata)
newdata['weight'] = newdata['weight'] / 100  # 정규화(학습할 때 정규화를 시켰기 때문에 필수)
newdata['height'] = newdata['height'] / 200  # 정규화
print(newdata)
