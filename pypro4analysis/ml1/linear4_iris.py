...
print(iris.iloc[:,0:4].corr())  # pandas 제공
...
print('result1 R_squared : ', result1.rsquared)  # 0.013822
print('result1 p-value : ', result1.pvalues[1])  # 0.151898 > 0.05이므로 모델은 유의하지 않다.
...
print('result2 p-value : ', result2.pvalues[1])  # 1.0386674194499606e-47 < 0.05이므로 유의한 모델
