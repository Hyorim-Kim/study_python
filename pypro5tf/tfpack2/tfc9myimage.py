...
img = np.array(im.resize((28, 28), Image.LANCZOS).convert('L'))  # 'L':그레이스케일, 'l:이진화, 'RGB' ... 
# LANCZOS : 높은 해상도의 사진 또는 영상을 낮은 해상도로 변환하거나 나타낼 때 깨진 패턴의 형태로 나타나게 되는데 이를 최소화 시켜주는 방법
print(img)
print(img.shape)
